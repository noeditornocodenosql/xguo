...
<body>
    ...
    <div class="rightinfo">
    <form action="${pageContext.request.contextPath}/saveCategorysOneLevel" method="post">
    <table class="tablelist">
       ...
       <th>一级菜单名称</th>
        ...
        <td><input type="submit"  value="添加" style="cursor:pointer"/> | <a href="${pageContext.request.contextPath}/categorysOneLevel" class="tablelink">返回</a></td>
        </tr> 
        </tbody>
    </table>
    </form>
