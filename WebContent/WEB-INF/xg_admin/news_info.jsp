...
$(function(){	
	  $(".saveBtn").click(function(){
		  location.href = "${pageContext.request.contextPath}/backstage/news/save";
	  });
	//弹出新增/修改/删除结果提示
...
<body>
    ...
    <li><a href="${pageContext.request.contextPath}/backstage/news/1">动态列表</a></li>
    </ul>
    </div>
    <div class="rightinfo">
    <div class="tools">
  ...
  <input type="hidden" id="message" value="${message }"/>    
    ...
    <li class="selected">
    <span><a href="${pageContext.request.contextPath}/backstage/news/update/${news.nId}/${page.pageNow}"><img src="${pageContext.request.contextPath}/${news.nThumbnail}" style="width: 168px;height: 126px;"/></a></span>
    <h2><a href="#">${news.nTitle }</a></h2>
    <p><a href="${pageContext.request.contextPath}/backstage/news/update/${news.nId}/${page.pageNow}">编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/backstage/news/delete/${news.nId}/${page.pageNow}">删除</a></p>
    </li>
    </c:forEach>
    </ul>
   ...
   <tr>
	<c:if test="${page.pageNow != 1}">
 		<td><a href="${pageContext.request.contextPath}/backstage/news/${page.pageNow-1}" style="text-decoration:none;">上一页</a></td>
		<td><a href="${pageContext.request.contextPath}/backstage/news/1" style="text-decoration:none;">1</a></td>
	<c:if test="${page.pageNow-1 != 1}">
		<td><span>...</span></td>
		<td><a href="${pageContext.request.contextPath}/backstage/news/${page.pageNow-1}" style="text-decoration:none;">${page.pageNow-1}</a></td>
	</c:if>
	</c:if>
	...
	<c:if test="${page.pageNow+1 != page.totalPageCount}">
		...
		<td><a href="${pageContext.request.contextPath}/backstage/news/${page.totalPageCount}" style="text-decoration:none;">${page.totalPageCount}</a></td>
	    <td><a href="${pageContext.request.contextPath}/backstage/news/${page.pageNow+1}" style="text-decoration:none;">下一页</a></td>
   </c:if>
 </tr>
</table>
    </div>
