...
$(function(){	
	//弹出新增/修改/删除结果提示
	  var message = $("#message").val();
	 	...
	 	//上传图片预览
	 	$("#up1").uploadPreview({ Img: "ImgPr1", Width: 300, Height: 450 });
});
</script>
</head>
<body>
    ...
    <li><a href="${pageContext.request.contextPath}/backstage/wordsupload">Words</a></li>
    </ul>
    </div>
    <div class="rightinfo">
    <div class="tools">
  ...
  <input type="hidden" id="message" value="${message }"/>    
    <form action="${pageContext.request.contextPath}/backstage/wordsupload" method="post" enctype="multipart/form-data">
    <ul class="forminfo">
     <li><label>Words<b>*</b></label><img id="ImgPr1" alt="" src="${pageContext.request.contextPath}/templets/Images/words.png"  style="width: 300px;height: 450px;">
     <input name="file" type="file" class="dfinput" style="width:150px;" id="up1"/>
     </li>
     <li><label>&nbsp;</label><input type="submit" class="btn" value="上传"/>&nbsp;&nbsp;&nbsp;&nbsp;<a style="color:gray;">(注意:图片名须为words.png,不可以是其他图片格式)</a></li>
    </ul>
    </form>
    </div>
