...
<body>
    ...
    <div class="rightinfo">
    <form action="${pageContext.request.contextPath}/saveAdmin" method="post">
    <table class="tablelist">
       ...
       <th>账号</th>
        ...
        <td><input type="text" name="aNickName"/></td>
        <td><input type="text" name="aEmail"/></td>
        <td><input type="submit"  value="添加" style="cursor:pointer"/> | <a href="${pageContext.request.contextPath}/accountSettings/1" class="tablelink">返回</a></td>
        </tr> 
        </tbody>
    </table>
    </form>
