...
<body>
    ...
    <li><a href="${pageContext.request.contextPath}/backstage/advertisementupload">动态详细页AD</a></li>
    </ul>
    </div>
    <div class="rightinfo">
    <div class="tools">
  ...
  <input type="hidden" id="message" value="${message }"/>    
    <form action="${pageContext.request.contextPath}/backstage/advertisementupload" method="post" enctype="multipart/form-data">
    <ul class="forminfo">
     <li><label>简介图(280x210)<b>*</b></label><img id="ImgPr1" alt="" src="${pageContext.request.contextPath}/templets/Picture/ad.jpg"  style="width:280px;height: 210px;">
     <input name="file" type="file" class="dfinput" style="width:150px;" id="up1"/>
     </li>
     <li><label>&nbsp;</label><input type="submit" class="btn" value="上传"/>&nbsp;&nbsp;&nbsp;&nbsp;<a style="color:gray;">(注意:图片名须为ad.jpg,不可以是其他图片格式)</a></li>
    </ul>
    </form>
    </div>
