...
<header>
   ...
   <div class="qzPagination">
		<c:if test="${page.pageNow != 1}">
 		<a class="disabled prev" href="${pageContext.request.contextPath}/news/${page.pageNow-1}">«</a>
		<a  class="current" href="${pageContext.request.contextPath}/news/1" >1</a>
	...
	<c:if test="${page.pageNow+1 != page.totalPageCount}">
	    ...
	    <a  class="next" href="${pageContext.request.contextPath}/news/${page.pageNow+1}">»</a>
   </c:if>
             </div>
         </div>
         </c:if>
