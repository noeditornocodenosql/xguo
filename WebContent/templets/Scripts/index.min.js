...
var Swiper = function (a, b) {
  ...
  if (window.getComputedStyle || (window.getComputedStyle = function (a) {
    ...
    D.addCallback = function (a, b) {
      var c,
      e = this;
      return e.params['on' + a] ? d(this.params['on' + a]) ? this.params['on' + a].push(b)  : 'function' == typeof this.params['on' + a] ? (c = this.params['on' + a], this.params['on' + a] = [
      ], this.params['on' + a].push(c), this.params['on' + a].push(b))  : void 0 : (this.params['on' + a] = [
